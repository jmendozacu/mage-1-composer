...
class RevSliderBase {
	...
	*/
    ...
    public static function get_svg_sets_url(){
        ...
        $svg_sets['Actions'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/action/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/action/');
        $svg_sets['Alerts'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/alert/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/alert/');
        $svg_sets['AV'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/av/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/av/');
        $svg_sets['Communication'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/communication/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/communication/');
        $svg_sets['Content'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/content/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/content/');
        $svg_sets['Device'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/device/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/device/');
        $svg_sets['Editor'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/editor/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/editor/');
        $svg_sets['File'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/file/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/file/');
        $svg_sets['Hardware'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/hardware/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/hardware/');
        $svg_sets['Images'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/image/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/image/');
        $svg_sets['Maps'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/maps/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/maps/');
        $svg_sets['Navigation'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/navigation/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/navigation/');
        $svg_sets['Notifications'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/notification/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/notification/');
        $svg_sets['Places'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/places/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/places/');
        $svg_sets['Social'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/social/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/social/');
        $svg_sets['Toggle'] = array('path' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_PATH . 'public/assets/assets/svg/toggle/', 'url' => Nwdthemes_Revslider_Helper_Framework::$RS_PLUGIN_URL . 'public/assets/assets/svg/toggle/');
